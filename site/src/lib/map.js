...
export function addLayerFromManifest(map, entry) {
  ...
  if (entry.kind === 'fill') {
    ...
    map.addLayer({
      ...
      paint: {
        'circle-color': entry.color, 'circle-opacity': 0.5, 'circle-stroke-color': '#fff', 'circle-stroke-width': 1,
    ...
    map.addLayer({
      ...
      paint: {
        'circle-color': entry.color, 'circle-radius': 3.5, 'circle-opacity': 0.85,
    ...
    map.addLayer({
      ...
      paint: {
        ...
        'circle-opacity': 0.85, 'circle-stroke-color': '#08306b', 'circle-stroke-width': 1.2,
      },
    });
    ...
    map.addLayer({
      ...
      paint: {
        ...
        'circle-color': entry.color, 'circle-opacity': 0.8,
